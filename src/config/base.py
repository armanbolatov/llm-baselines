...
def parse_args(base_parser, args, namespace):
    ...
    parser.add_argument("--online_merge_method", default="off",
                        choices=["off", "mean", "ema", "theorem"])
    ...
    # logging params (TensorBoard)
    parser.add_argument("--tensorboard", action="store_true")  # whether to use TensorBoard or not
    parser.add_argument("--tensorboard_dir", default="tb_logs", type=str)
    parser.add_argument(
    ...
    parser.add_argument(
        "--scheduler",
        default="cos",
        choices=["linear", "cos", "wsd", "wsm", "none", "cos_inf", "cos_wsd", "dd"],
    )
